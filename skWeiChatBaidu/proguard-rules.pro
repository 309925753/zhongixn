...
-keep class com.vkzwbim.chat.AppConfig {*;}
#xUtils(保持注解，及使用注解的Activity不被混淆，不然会影响Activity中你使用注解相关的代码无法使用)
-keep class * extends java.lang.annotation.Annotation {*;}
-keep class com.vkzwbim.chat.activity.** {*;}
...
-keep class com.vkzwbim.chat.util.SkinUtils.Skin { *; }
-keep class com.vkzwbim.chat.bean.** { *; }
-keep class com.vkzwbim.chat.ui.live.bean.** { *; }
-keep class com.vkzwbim.chat.ui.mucfile.bean.** { *; }
...
-keep class com.vkzwbim.chat.ui.me.redpacket.alipay.** { *; }
-keep class com.alipay.android.app.IAlixPay{*;}
-keep class com.alipay.android.app.IAlixPay$Stub{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback{*;}
-keep class com.alipay.android.app.IRemoteServiceCallback$Stub{*;}
