...
import com.vkzwbim.chat.ui.me.redpacket.PayComfirmVerifyDialog;
import com.vkzwbim.chat.ui.me.redpacket.PayPasswordVerifyDialog;
import com.vkzwbim.chat.util.AsyncUtils;
import com.vkzwbim.chat.util.secure.AES;
import com.vkzwbim.chat.util.secure.MAC;
import com.vkzwbim.chat.util.secure.PayPassword;
import com.vkzwbim.chat.util.secure.RSA;
...
public class PaySecureHelper {
     ...
     */
    @MainThread
    public static Dialog inputPayPwd(Context ctx,  Function<String> onSuccess) {
        PayComfirmVerifyDialog dialog = new PayComfirmVerifyDialog(ctx);
        dialog.setOnInputFinishListener(password -> {
            onSuccess.apply(password);
        });
        try {
