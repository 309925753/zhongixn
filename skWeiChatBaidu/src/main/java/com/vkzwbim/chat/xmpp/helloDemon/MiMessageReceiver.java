...
public class MiMessageReceiver extends PushMessageReceiver {
    ...
    public void onReceivePassThroughMessage(Context context, MiPushMessage message) {
        LogUtil.e("cjh onReceivePassThroughMessage  "+message.getMessageType()+" : "+message.getContent());
    ...
    public void onNotificationMessageClicked(Context context, MiPushMessage message) {
        ...
        LogUtil.e("cjh 小米onNotificationMessageClicked  "+message.getMessageType()+" : "+message.getContent());
    ...
    public void onNotificationMessageArrived(Context context, MiPushMessage message) {
        LogUtil.e("cjh 小米onNotificationMessageArrived  "+message.getMessageType()+" : "+message.getContent());
        mMessage = message.getContent();
        if (!TextUtils.isEmpty(message.getTopic())) {
            mTopic = message.getTopic();
        } else if (!TextUtils.isEmpty(message.getAlias())) {
