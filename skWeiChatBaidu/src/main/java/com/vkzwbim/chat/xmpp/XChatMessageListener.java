...
import com.vkzwbim.chat.audio.NoticeVoicePlayer;
import com.vkzwbim.chat.bean.CodePay;
...
import com.vkzwbim.chat.db.InternationalizationHelper;
...
import com.vkzwbim.chat.pay.EventPaymentSuccess;
import com.vkzwbim.chat.pay.EventReceiptSuccess;
import com.vkzwbim.chat.ui.base.CoreManager;
import com.vkzwbim.chat.ui.circle.MessageEventNotifyDynamic;
import com.vkzwbim.chat.ui.login.AuthLoginActivity;
import com.vkzwbim.chat.ui.message.ChatActivity;
import com.vkzwbim.chat.ui.message.HandleSyncMoreLogin;
...
import static com.vkzwbim.chat.xmpp.listener.ChatMessageListener.MESSAGE_SEND_SUCCESS;
...
public class XChatMessageListener implements IncomingChatMessageListener {
    ...
    public void newIncomingMessage(EntityBareJid entityBareJid, Message message, Chat chat) {
        ...
        LogUtil.e("cjh newIncomingMessage "+message.getBody().toString());
        // body外
        ...
        if ((chatMessage.getType() >= XmppMessage.TYPE_SYNC_OTHER && chatMessage.getType() <= XmppMessage.TYPE_SYNC_GROUP)
        ...
        if (from.contains(mLoginUserId)) {
            ...
            if (friend != null && friend.getOfflineNoPushMsg() == 0) {
                if (chatMessage.getType()==XmppMessage.TYPE_IS_CONNECT_VOICE){
                    Intent intent=new Intent(MyApplication.getInstance().getApplicationContext(), TalkRecieveActivity.class);
                    intent.putExtra("mLoginUserId",mLoginUserId);
                    intent.putExtra("toUserName",friend.getNickName());
