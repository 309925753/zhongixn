...
import com.vkzwbim.chat.ui.account.ChangePasswordActivity;
import com.vkzwbim.chat.ui.account.LoginHistoryActivity;
import com.vkzwbim.chat.ui.backup.BackupHistoryActivity;
...
import com.vkzwbim.chat.util.GetFileSizeUtil;
...
import com.vkzwbim.chat.xmpp.helloDemon.IntentWrapper;
...
public class SettingActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentFilter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.SEND_MULTI_NOTIFY);
        intentFilter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.NO_EXECUTABLE_INTENT);
    ...
    private class My_BroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!TextUtils.isEmpty(action)) {
                if (action.equals(com.vkzwbim.chat.broadcast.OtherBroadcast.SEND_MULTI_NOTIFY)) {// 群发消息结束，关闭当前界面
                    finish();
                } else if (action.equals(com.vkzwbim.chat.broadcast.OtherBroadcast.NO_EXECUTABLE_INTENT)) {// 无可执行的intent 需提醒用户
