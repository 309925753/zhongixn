    ...
    public static boolean isNotChatVisibility(int type) {
        ...
        if (type == XmppMessage.TYPE_READ) { // 已读消息还是要保存的， 不让它查询出来就行了
            ...
            if (type == XmppMessage.TYPE_END_CONNECT_VOICE) {
                ...
                b = false;
            } else if (type == XmppMessage.TYPE_NO_RECEIVE) {
                b = false;
            ...
            else if (type == XmppMessage.TYPE_END_BUSY_CONNECT_VOICE) {
                b = false;
            }
            else if (type == XmppMessage.TYPE_END_FROM_CONNECT_VOICE) {
                b = false;
            }  else if (type == XmppMessage.TYPE_END_FROM) {
                b = false;
            }
