...
import com.vkzwbim.chat.ui.circle.util.RefreshListImp;
...
public class BusinessCircleActivity extends BaseActivity implements showCEView, RefreshListImp {
    ...
    private TextView tv_friend_description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent() != null) {
            ...
            decri = getIntent().getStringExtra("decri");
    ...
    private void initCoverView() {
        ...
        tv_friend_description=mMyCoverView.findViewById(R.id.tv_friend_description);
        mAvatarImg = (ImageView) mMyCoverView.findViewById(R.id.avatar_img);

        if (decri!=null){
            tv_friend_description.setText(decri);
        }
        // 头像
