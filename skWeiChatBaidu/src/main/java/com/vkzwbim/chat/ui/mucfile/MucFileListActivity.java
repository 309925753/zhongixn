...
import com.vkzwbim.chat.view.LoadingDialog;
import com.vkzwbim.chat.view.MulFileDeleteSelectionFrame;
...
import static com.vkzwbim.chat.ui.mucfile.DownManager.STATE_DOWNLOADED;
import static com.vkzwbim.chat.ui.mucfile.DownManager.STATE_DOWNLOADING;
import static com.vkzwbim.chat.ui.mucfile.DownManager.STATE_PAUSEDOWNLOAD;
import static com.vkzwbim.chat.ui.mucfile.DownManager.STATE_UNDOWNLOAD;
...
public class MucFileListActivity extends BaseListActivity<MucFileListActivity.MucFileHolder> implements DownManager.DownLoadObserver {
    ...
    private void onItemLongClick(final int layoutPosition) {
        ...
        mulFileDeleteSelectionFrame.setFrameInitSuccessListener(() -> {
            ...
            View view = mulFileDeleteSelectionFrame.getView();
