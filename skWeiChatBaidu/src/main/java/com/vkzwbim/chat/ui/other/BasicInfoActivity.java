...
import com.vkzwbim.chat.db.dao.UserAvatarDao;
...
import com.vkzwbim.chat.view.BasicInfoWindow;
...
import com.vkzwbim.chat.view.ReportDialog;
...
import com.vkzwbim.chat.xmpp.listener.NewFriendListener;
...
public class BasicInfoActivity extends BaseActivity implements NewFriendListener {
                ...
                case R.id.report_tv:
                    ReportDialog mReportDialog = new ReportDialog(BasicInfoActivity.this, false, new ReportDialog.OnReportListItemClickListener() {
                        ...
                        public void onReportItemClick(Report report) {
                            ...
                            Intent intent=new Intent(BasicInfoActivity.this, ReportActivity.class);
                            intent.putExtra("ReportIdKey",report.getReportId()+"");
                            intent.putExtra("RoomId",mUserId);
    ...
    private void initEvent() {
        ...
        rl_report.setOnClickListener(v -> {
            ReportDialog mReportDialog = new ReportDialog(BasicInfoActivity.this, false, new ReportDialog.OnReportListItemClickListener() {
                @Override
                public void onReportItemClick(Report report) {
        ...
        findViewById(R.id.look_bussic_cicle_rl).setOnClickListener(view -> {
            if (mUser != null) {
//                String dec="";
//                if (mUser.getDescription()==null||TextUtils.isEmpty(mUser.getDescription())){
//                    dec="这家伙很懒，什么都没留下";
//                }else{
//                    dec=mUser.getDescription();
//                }
                ...
                intent.putExtra("decri",mUser.getDescription());
    ...
    private void updateUI() {
        ...
        if (TextUtils.isEmpty(mUser.getAccount())) {  //如果众信聊天号为空则不显示
            findViewById(R.id.ll_communication).setVisibility(View.GONE);
        } else {
            tv_number.setText(mUser.getAccount());  //否则显示众信聊天号
        }
    ...
    public void msgSendSuccess(NewFriendMessage message, String packet) {
        if (addhaoyouid != null && addhaoyouid.equals(packet)) {
            ...
            deleteChatMessage.setContent(mUser.getUserType() == 2 ? getString(R.string.delete_firend_public) : getString(R.string.delete_firend) + " " + mUser.getNickName());
