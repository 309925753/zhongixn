...
import com.vkzwbim.chat.adapter.MessageContactEvent;
import com.vkzwbim.chat.adapter.MessageEventBG;
...
import com.vkzwbim.chat.bean.EventCreateGroupFriend;
import com.vkzwbim.chat.bean.EventSendVerifyMsg;
import com.vkzwbim.chat.bean.Friend;
import com.vkzwbim.chat.bean.UploadingFile;
...
import com.vkzwbim.chat.broadcast.TimeChangeReceiver;
import com.vkzwbim.chat.broadcast.UpdateUnReadReceiver;
import com.vkzwbim.chat.broadcast.UserLogInOutReceiver;
import com.vkzwbim.chat.db.dao.ChatMessageDao;
import com.vkzwbim.chat.db.dao.ContactDao;
import com.vkzwbim.chat.db.dao.FriendDao;
import com.vkzwbim.chat.db.dao.MyZanDao;
import com.vkzwbim.chat.db.dao.NewFriendDao;
import com.vkzwbim.chat.db.dao.OnCompleteListener2;
import com.vkzwbim.chat.db.dao.UploadingFileDao;
import com.vkzwbim.chat.db.dao.UserDao;
import com.vkzwbim.chat.db.dao.login.MachineDao;
import com.vkzwbim.chat.downloader.UpdateManger;
import com.vkzwbim.chat.fragmen.FindFragment;
import com.vkzwbim.chat.fragment.FriendFragment;
import com.vkzwbim.chat.fragment.MeFragment;
...
import com.vkzwbim.chat.ui.backup.ReceiveChatHistoryActivity;
import com.vkzwbim.chat.ui.base.BaseActivity;
import com.vkzwbim.chat.ui.base.CoreManager;
import com.vkzwbim.chat.ui.lock.DeviceLockActivity;
import com.vkzwbim.chat.ui.lock.DeviceLockHelper;
import com.vkzwbim.chat.ui.login.WebLoginActivity;
...
import com.vkzwbim.chat.view.SelectionLongFrame;
import com.vkzwbim.chat.view.VerifyDialog;
import com.vkzwbim.chat.xmpp.CoreService;
import com.vkzwbim.chat.xmpp.helloDemon.FirebaseMessageService;
import com.vkzwbim.chat.xmpp.helloDemon.HuaweiClient;
import com.vkzwbim.chat.xmpp.helloDemon.OppoPushMessageService;
...
//        initLanguage();
    ...
    private void initBroadcast() {
        ...
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.SYNC_CLEAN_CHAT_HISTORY);
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.SYNC_SELF_DATE);
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.CollectionRefresh);
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.SEND_MULTI_NOTIFY);  // 群发消息结束
        ...
        if (fragment == null) {
            switch (checkedId) {
                ...
                case R.id.rb_tab_2:
                    ...
                    break;
                case R.id.rb_tab_3:
                    LogUtil.e("cjh  coreManager.getConfig().newUi" + coreManager.getConfig().newUi);
    ...
    */
                                    ...
                                    if (coreManager.isLogin()) {
                                        ...
                                        for (int i = 0; i < mFriends.size(); i++) {// 已加入的群组不会重复加入，方法内已去重
                                            coreManager.joinMucChat(mFriends.get(i).getUserId(),
                                                    TimeUtils.sk_time_current_time() - mFriends.get(i).getTimeSend());
                                        }
                                    }
    ...
    private class My_BroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            } else if (action.equals(com.vkzwbim.chat.broadcast.OtherBroadcast.SEND_MULTI_NOTIFY)) {
