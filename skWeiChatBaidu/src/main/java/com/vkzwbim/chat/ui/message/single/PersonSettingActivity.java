...
private RelativeLayout rl_read;
    ...
    private void initView() {
        ...
        if (coreManager.getConfig().displayRedPacket||coreManager.getSelf().getPhone().equals("18899991111")) {
                ...
                .execute(new BaseCallback<Void>(Void.class) {
                    ...
                    public void onResponse(ObjectResult<Void> result) {
                        ...
                        if (result.getResultCode() == 1) {
                            ...
                            sendBroadcast(new Intent(com.vkzwbim.chat.broadcast.OtherBroadcast.NAME_CHANGE));// 刷新聊天界面
                        } else {
    ...
    private void registerReceiver() {
        ...
        intentFilter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.QC_FINISH);
    ...
    public class RefreshBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(com.vkzwbim.chat.broadcast.OtherBroadcast.QC_FINISH)) {
