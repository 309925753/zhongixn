...
import com.vkzwbim.chat.util.secure.MD5;
...
//        btn_change.setBackgroundColor(SkinUtils.getSkin(this).getAccentColor());
        ...
        if (coreManager.getSelf() != null && !TextUtils.isEmpty(coreManager.getSelf().getPhone())) {
            String telephone = coreManager.getSelf().getPhone();
            ...
            if (!TextUtils.isEmpty(userId)) {
                ...
                if (mLastLoginUser != null) {
                    ...
                    int mobilePrefix = PreferenceUtils.getInt(ResetPayPasswordActivity.this, Constants.AREA_CODE_KEY, -1);
