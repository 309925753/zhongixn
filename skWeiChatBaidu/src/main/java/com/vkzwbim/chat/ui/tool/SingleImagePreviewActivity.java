...
import com.vkzwbim.chat.ui.message.HandleQRCodeScanUtil;
import com.vkzwbim.chat.util.FileUtil;
import com.vkzwbim.chat.view.SaveWindow;
...
public class SingleImagePreviewActivity extends BaseActivity {
    ...
    private void register() {
        ...
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.singledown);
        filter.addAction(com.vkzwbim.chat.broadcast.OtherBroadcast.longpress);
        ...
        if (resultCode == Activity.RESULT_OK) {
            switch (requestCode) {
                case REQUEST_IMAGE_EDIT:
                    ...
                    // 模拟那个长按，弹出菜单，
                    Intent intent = new Intent(com.vkzwbim.chat.broadcast.OtherBroadcast.longpress);
    ...
    class My_BroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(com.vkzwbim.chat.broadcast.OtherBroadcast.singledown)) {
                // 轻触屏幕，退出预览
                doBack();
            } else if (intent.getAction().equals(com.vkzwbim.chat.broadcast.OtherBroadcast.longpress)) {
                // 长按屏幕，弹出菜单
