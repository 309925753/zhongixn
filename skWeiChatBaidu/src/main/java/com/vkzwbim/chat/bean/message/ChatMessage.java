package com.vkzwbim.chat.bean.message;
...
import com.vkzwbim.chat.db.dao.ChatMessageDaoImpl;
import com.vkzwbim.chat.helper.MessageSecureHelper;
 ...
 * @包名: com.vkzwbim.chat.bean.message
 * @作者:王阳
...
public class ChatMessage extends XmppMessage implements Parcelable {
    public static final Creator<ChatMessage> CREATOR = new Creator<ChatMessage>() {
        ...
        public ChatMessage createFromParcel(Parcel source) {
            ...
            message.isDiceSelect=source.readInt();
            message.content = source.readString();
            message.videoLength = source.readString();
    ...
    public int getIsDiceSelect() {
        return isDiceSelect;
    }

    public void setIsDiceSelect(int isDiceSelect) {
        this.isDiceSelect = isDiceSelect;
    }
    ...
    private void parserJsonData(String jsonData) {
        try {
            ...
            videoLength=getStringValueFromJSONObject(jObject, "videoLength");
    ...
    public JSONObject toJsonObject(@Nullable String messageKey) {
        ...
        if (!TextUtils.isEmpty(this.videoLength)) {
            object.put("videoLength", this.videoLength);
        }
