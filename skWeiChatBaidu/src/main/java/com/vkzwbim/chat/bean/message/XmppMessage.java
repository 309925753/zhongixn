...
public abstract class XmppMessage {
    ...
    public static final int TYPE_NO_CONNECT_VOICE = 103;//    拒绝语音通话
    public static final int TYPE_END_CONNECT_VOICE = 104;// 结束语音通话
    public static final int TYPE_END_BUSY_CONNECT_VOICE = 105;// 忙线
    public static final int TYPE_END_FROM_CONNECT_VOICE = 106;// 对方拒绝语音通话
    public static final int TYPE_NO_RECEIVE = 107;//来电不响应(30s)内，无应答
    public static final int TYPE_END_FROM = 108;//对方结束语音通话
    ...
    public static final int TYPE_SEAL = 811; //封号
