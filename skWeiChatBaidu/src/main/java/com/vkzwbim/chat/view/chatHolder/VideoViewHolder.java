...
import com.vkzwbim.chat.downloader.DownloadListener;
import com.vkzwbim.chat.downloader.DownloadProgressListener;
...
import com.vkzwbim.chat.video.ChatVideoPreviewActivity;
...
public class VideoViewHolder extends AChatHolderInterface implements DownloadListener, DownloadProgressListener {
    ...
    public void initView(View view) {
        ...
        tv_timelength = view.findViewById(R.id.tv_timelength);
    ...
    public void fillData(ChatMessage message) {
        ...
        tv_timelength.setText(message.getVideoLength());
        if (!isExist) {
