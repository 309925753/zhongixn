...
import static com.vkzwbim.chat.R.id.tv_group;
...
public class SelectFileDialog extends Dialog {
    ...
    private Future<?> queryDocument() {
        ...
        return AsyncUtils.doAsync(this, e -> {
            ...
            List<FileType> typeList = Arrays.asList(
                    new FileType("doc", wodDatas, 6, 1024 * 1024 * 10),
                    new FileType("xls", wodDatas, 5, 1024* 1024 * 10),
                    new FileType("ppt", wodDatas, 4, 1024 * 1024* 10),
                    new FileType("pdf", wodDatas, 10, 1024 * 1024* 10)
            );
