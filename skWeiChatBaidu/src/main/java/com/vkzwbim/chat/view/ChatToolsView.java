...
import com.vkzwbim.chat.ui.message.assistant.GroupAssistantDetailActivity;
import com.vkzwbim.chat.ui.message.assistant.SelectGroupAssistantActivity;
...
public class ChatToolsView extends RelativeLayout {
    ...
    public GroupVideoChatToolDialog.OnVideoChatToolDialogClickListener onVideoChatToolDialogClickListener = new GroupVideoChatToolDialog.OnVideoChatToolDialogClickListener() {
        @Override
...
//                }),
                ...
                new Item(R.drawable.im_tool_video_button_bg, R.string.chat_audio, () -> {
                    listener.clickVideoChat();
                }),
