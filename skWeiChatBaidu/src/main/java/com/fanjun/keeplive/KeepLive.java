...
public final class KeepLive {
    ...
    public static final ForegroundNotification foregroundNotification = new ForegroundNotification(MyApplication.getContext().getString(R.string.keep_live_title),
            MyApplication.getContext().getString(R.string.keep_live_description), R.drawable.logo,
            //定义前台服务的通知点击事件
            null);
